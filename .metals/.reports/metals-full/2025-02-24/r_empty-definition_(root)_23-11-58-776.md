error id: file://<WORKSPACE>/src/main/scala/org/ntic/flights/FlightsLoaderApp.scala:12
...
non-local guesses:
	 -FlightsLoaderConfig.
	 -scala/Predef.FlightsLoaderConfig.
...
object FlightsLoaderApp extends App {
  ...
  val rows: Seq[Try[Row]] = fileLines.map(Row.fromLine)
