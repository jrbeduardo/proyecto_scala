error id: file://<WORKSPACE>/src/main/scala/org/ntic/flights/FlightsLoaderApp.scala:25
...
non-local guesses:
	 ...
	 -FileUtils.writeObjectToFile#
	 -FileUtils.writeObjectToFile().
	 -scala/Predef.FileUtils.writeObjectToFile.
	 -scala/Predef.FileUtils.writeObjectToFile#
	 -scala/Predef.FileUtils.writeObjectToFile().
...
object FlightsLoaderApp extends App {
  ...
  val rows: Seq[Try[Row]] =  fileLines.map(line => Row.fromStringList(line.split(FlightsLoaderConfig.delimiter).toSeq))
