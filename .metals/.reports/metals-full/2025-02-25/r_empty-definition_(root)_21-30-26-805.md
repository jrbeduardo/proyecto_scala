error id: scala/io/BufferedSource#getLines().
file://<WORKSPACE>/src/main/scala/org/ntic/flights/data/FileUtils.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol scala/io/BufferedSource#getLines().
...
object FileUtils {
  ...
  def loadFromFileLines(fileLines: Seq[String]): Seq[Try[Row]] = {
    ...
    fileLines.map(line => Row.fromStringList(line.split(FlightsLoaderConfig.delimiter).toSeq))
